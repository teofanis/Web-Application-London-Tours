...
<body>
            ...
            <form action="index.php" method="GET" class="form-inline my-2 my-lg-0">
                ...
                <?php if(isset($_SESSION['logged_in'])) {echo '<a class="nav-link dropdown-toggle btn btn-outline-info ml-2" id="accountSettings" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="accountSettings">
                        ...
                        <div class="dropdown-divider"></div>';}?>
                <?php if(isset($_SESSION['logged_in']) && (isset($_SESSION['privileges']) && ($_SESSION['privileges'])==1)) {
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="display-4">Experience a majestic world with London Tours</h1>
            <p class="lead">Explore the mysteries of Hogwarts and Harry potter with our exclusive tour for a limited time !</p>
            <hr class="my-4">
            <p>You will join a team of professionals and visit the famous sights that you fall inlove with in the series! </p>
            <a class="btn btn-primary btn-lg" data-toggle="modal" data-target="#LoginModalCenter" role="button">Learn more</a>
        </div>
        ...
        <div class="row">
            ...
            ?>
            <?php
                    $query = "SELECT * from products limit $page1,9";
                    $result = $mysqli->query($query);
                    if($result != null){
                        while($row = $result->fetch_array()){
                        echo ' <div class="col-lg-4 col-md-6 col-sm-10 ">
                            <div class="thumbnail text-center">
                                <img src="'.$row["productImage"].'" class="img-thumbnail" alt=".$row["productTitle"].">
                                <div class="caption post-content">
                                     <a class="deal" href="includes/service.php?id='.$row["productID"].'">
                    ...
                    <form action="<?php echo($_SERVER['PHP_SELF']);?>" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="priviledges" value="0" id="priviledges" required>
    ...
    <!-- Messenger Modal -->
    <div class="modal fade" id="MessengerModal" tabindex="-1" role="dialog" aria-labelledby="MessengerModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="MessengerModalTitle">
