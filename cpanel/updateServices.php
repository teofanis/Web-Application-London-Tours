...
<div class="container">
    ...
    <form method="POST" action="">
        <div class="form-group">
            <label for="ServiceFromInput">
                <h4>Select a service from the dropdown below to modift it</h4>
    ...
    ?>
        ...
        <button type="submit" class="btn btn-primary mt-2 mb-2" name="submit">Update Service</button>
    </form>
    <?php 
     if(isset($_POST['submit'])){
       $value = $_POST["products"];
          ...
          $productImage = $mysqli->escape_string($_POST['productImage']);
            ...
            $sql = "Update products SET productTitle= '$productTitle', productDescription='$productDescription', productImage='$productImage' WHERE productID ='$value'";
